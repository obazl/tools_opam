/* Generated by re2c 2.0.3 on Wed Sep 29 14:00:00 2021 */
#line 1 "./metalexer.re"
// findlib META lexer
...
yy2:
	++lexer->cursor;
#line 230 "./metalexer.re"
	{
        /* printf("ending\n"); */
        return 0;
        }
#line 189 "./metalexer.c"
yy4:
	++lexer->cursor;
yy5:
#line 226 "./metalexer.re"
	{
            fprintf(stderr, "ERROR lexing: %s: %s\n", lexer->filename, lexer->cursor);
            exit(-1);
        }
#line 198 "./metalexer.c"
yy6:
	yyaccept = 0;
...
yy8:
#line 120 "./metalexer.re"
	{ goto loop; }
#line 286 "./metalexer.c"
yy9:
	yyaccept = 1;
	yych = *(lexer->marker = ++lexer->cursor);
	switch (yych) {
...
yy13:
#line 191 "./metalexer.re"
	{ return LPAREN; }
#line 400 "./metalexer.c"
yy14:
	++lexer->cursor;
#line 192 "./metalexer.re"
	{ return RPAREN; }
#line 405 "./metalexer.c"
yy16:
	yych = *++lexer->cursor;
	switch (yych) {
	case '=':	goto yy45;
...
yy17:
	++lexer->cursor;
#line 119 "./metalexer.re"
	{ goto loop; }
#line 416 "./metalexer.c"
yy19:
	yych = *++lexer->cursor;
yy20:
	switch (yych) {
...
yy21:
	s1 = yyt2;
	s2 = yyt3;
#line 165 "./metalexer.re"
	{
            mtok->s = strndup(s1, (size_t)(s2 - s1));
            return VNAME;
        }
#line 503 "./metalexer.c"
yy22:
	yych = *++lexer->cursor;
	switch (yych) {
	case '\t':
...
yy24:
#line 224 "./metalexer.re"
	{ return EQ; }
#line 515 "./metalexer.c"
yy25:
	yych = *++lexer->cursor;
	switch (yych) {
	case 'i':	goto yy49;
...
yy34:
	...
	s1 = lexer->cursor - 1;
	s2 = lexer->cursor - 1;
#line 180 "./metalexer.re"
	{
            mtok->s = NULL;
            return WORD;
        }
#line 664 "./metalexer.c"
yy36:
	++lexer->cursor;
#line 122 "./metalexer.re"
	{
            /* return COMMENT; */
            goto loop;          /* skip comments */
        }
#line 672 "./metalexer.c"
yy38:
	yych = *++lexer->cursor;
	switch (yych) {
	case '\t':
...
yy45:
	++lexer->cursor;
#line 223 "./metalexer.re"
	{ return PLUSEQ; }
#line 854 "./metalexer.c"
yy47:
	yych = *++lexer->cursor;
	switch (yych) {
	case '\t':
...
yy53:
	...
	s1 = yyt1;
	s2 = lexer->cursor - 1;
#line 170 "./metalexer.re"
	{
            mtok->s = strndup(s1, (size_t)(s2 - s1));
            return WORD;
        }
#line 896 "./metalexer.c"
yy55:
	++lexer->cursor;
	s1 = yyt1;
	s2 = lexer->cursor - 1;
#line 175 "./metalexer.re"
	{
            mtok->s = strndup(s1, (size_t)(s2 - s1));
            return WORDS;
        }
#line 906 "./metalexer.c"
yy57:
	yych = *++lexer->cursor;
	switch (yych) {
	case '\t':
...
yy85:
	s2 = yyt1;
	s1 = yyt1 - 8;
#line 127 "./metalexer.re"
	{ return REQUIRES; }
#line 1287 "./metalexer.c"
yy86:
	yyaccept = 3;
	yych = *(lexer->marker = ++lexer->cursor);
	switch (yych) {
...
yy98:
	s1 = yyt1;
	s2 = yyt2;
#line 186 "./metalexer.re"
	{
            mtok->s = strndup(s1, (size_t)(s2 - s1));
            return PACKAGE;
        }
#line 1421 "./metalexer.c"
yy99:
	yych = *++lexer->cursor;
	switch (yych) {
	case 'e':	goto yy101;
...
yy107:
	s1 = yyt1;
	s2 = yyt2;
#line 149 "./metalexer.re"
	{
        mtok->s = strndup(s1, (size_t)(s2-s1));
            return DIRECTORY;
        }
#line 1603 "./metalexer.c"
yy108:
	yych = *++lexer->cursor;
	switch (yych) {
	case 'e':	goto yy109;
...
yy112:
	s2 = yyt1;
	s1 = yyt1 - 16;
#line 129 "./metalexer.re"
	{ return PPX_RUNTIME_DEPS; }
#line 1704 "./metalexer.c"
yy113:
	yych = *++lexer->cursor;
	switch (yych) {
	case '\t':
